...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        <div class="container-fluid mr-4">
            <div>
                <h2 class="ttl Row">Gerenciamento de áreas poliesportivas</h2>
                <hr />
                <h6 class="inputTitle">Dados da Área</h6>
                <div class="row ml-1" >                
                    <div class="col-sm-6">
                        <h6 class="inputTitle">Nome:</h6>
                        <asp:TextBox ID="TextBoxName" CssClass="w-75" runat="server"></asp:TextBox>
                        ...
                        <asp:TextBox ID="TextBoxDesc" TextMode="MultiLine" CssClass="w-100" runat="server"></asp:TextBox>
